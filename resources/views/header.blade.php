					...
					<div class="beta-comp">
					 @if(Session::has('cart'))
						<div class="cart">
							...
							{{Session('cart')->totalQty}} @else trong @endif) <i class="fa fa-chevron-down"></i></div>
							<div class="beta-dropdown cart-body">
							
							@foreach($product_cart as $product)
								<div class="cart-item">
									<div class="media">
										<a class="pull-left" href="#"><img src="source/images/product/{{$product['item']['image']}}" alt=""></a>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="{{route('loaisanpham',0)}}"> loai Sản phẩm</a>
							<ul class="sub-menu">
